 ...
 * @author User
 */
public final class grade7 extends javax.swing.JInternalFrame {
       Connection con = null;
       PreparedStatement pst = null;
        ResultSet rs = null;
    /**
     * Creates new form grade7
     */
    public grade7() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tablegrade7 = new javax.swing.JTable();
        ...
        jLabel1.setText("Grade 7 Student's Details");

        tablegrade7.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tablegrade7.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablegrade7MouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tablegrade7);
    ...
    private void tablegrade7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablegrade7MouseClicked
        int r = tablegrade7.getSelectedRow();
        
        String id = tablegrade7.getValueAt(r, 0).toString();
        String name = tablegrade7.getValueAt(r, 1).toString();
        String cls = tablegrade7.getValueAt(r, 2).toString();
        String subcls = tablegrade7.getValueAt(r, 3).toString();
    ...
    }//GEN-LAST:event_tablegrade7MouseClicked
public void tableload()
    {
        ...
        try{
                ...
                String q2 = "SELECT  addid, sname, sclass,ssubclass FROM studentdetails WHERE sclass = 7 ";
                 pst = con.prepareStatement(q2);
                 rs =   pst.executeQuery();
               
             //   tablegrade7.setModel(DbUtils.resultSetToTableModel(rs));
        }
        catch(Exception e)
        {
    ...
    private javax.swing.JTable tablegrade7;
